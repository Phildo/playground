...
var Atan2Scene = function(space, stage)
{
  var self = this;
  ...
  function propagate()
  {
    self.atana = Math.atan2(a.y,a.x);
    self.atanb = Math.atan2(b.y,b.x);
    self.atanasubb = self.atana-self.atanb;
  ...
  self.draw = function()
  {
    ...
    cx.fillText(self.atana, ca.height+10, ca.height-20);
    cx.fillText(self.atanb, ca.height+10, ca.height-10);
    cx.fillText(self.atanasubb, ca.height+10, ca.height-0);
  };
